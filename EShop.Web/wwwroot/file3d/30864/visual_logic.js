 ...
 * Wed Jan 18 2023 01:10:51 GMT+0330 (Iran Standard Time)
...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.026241, 0.030713, 0.03434, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.026241, 0.030713, 0.03434, '');
OffOn = 0;
...
eventHTMLElem('click', 'PhantomBlack', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.026241, 0.030713, 0.03434, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.026241, 0.030713, 0.03434, '');
});
...
eventHTMLElem('click', 'White', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.938685, 0.938685, 1, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.938685, 0.938685, 1, '');
});
...
eventHTMLElem('click', 'PinkGold', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.887922, 0.672443, 0.617207, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.887922, 0.672443, 0.617207, '');
});

eventHTMLElem('click', 'Green', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.020288, 0.05448, 0.042311, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.020288, 0.05448, 0.042311, '');
});

eventHTMLElem('click', 'BoraPurple', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.603827, 0.520995, 0.760524, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.603827, 0.520995, 0.760524, '');
});
