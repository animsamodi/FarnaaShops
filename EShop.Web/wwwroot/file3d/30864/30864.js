...
(function() {
  ...
  //  var sceneURL = params.load ? params.load : '__URL__SamSung_S_22.gltf'.replace('__URL__', '');
    var logicURL = '../file3d/30864/visual_logic.js';
    var sceneURL = '../file3d/30864/SamSung_S_22.gltf';
    if (!sceneURL) {
