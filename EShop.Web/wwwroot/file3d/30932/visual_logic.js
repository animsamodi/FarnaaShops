 ...
 * Tue Feb 21 2023 01:07:30 GMT+0330 (Iran Standard Time)
...
setMaterialColor('Body 1', 'Principled BSDF Color', 0, 0, 0, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0, 0, 0, '');
OffOn = 0;
...
eventHTMLElem('click', 'Blue', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.300543, 0.456411, 0.584078, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.300543, 0.456411, 0.584078, '');
});
...
eventHTMLElem('click', 'Pink', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.571124, 0.496932, 0.558341, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.571124, 0.496932, 0.558341, '');
});

eventHTMLElem('click', 'Green', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.28744, 0.391572, 0.366253, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.28744, 0.391572, 0.366253, '');
});
