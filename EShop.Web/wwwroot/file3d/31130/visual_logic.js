...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.013702, 0.033105, 0.031896, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.013702, 0.033105, 0.031896, '');
OffOn = 0;
...
eventHTMLElem('click', 'White', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.701101, 0.775822, 0.791298, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.701101, 0.775822, 0.791298, '');
});
...
eventHTMLElem('click', 'Pink', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.752942, 0.3564, 0.304987, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.752942, 0.3564, 0.304987, '');
});
