...
(function() {
   ...
   // var logicURL = params.logic ? params.logic : '__LOGIC__visual_logic.js'.replace('__LOGIC__', '');
    //var sceneURL = params.load ? params.load : '__URL__Samsung_A_52_s.gltf'.replace('__URL__', '');
    var logicURL = '../file3d/10393/visual_logic.js';
    var sceneURL = '../file3d/10393/Samsung_A_52_s.gltf';
    if (!sceneURL) {
