...
assignMat('Body 1', 'Body 1 Black');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.048933, 0.048933, 0.048933, '');
OffOn = 0;

eventHTMLElem('click', 'OffOn', false, function(event) {
  if (OffOn == 0) {
    OffOn = 1;
    assignMat('screen on', 'Screen Off');
  } else {
    OffOn = 0;
    assignMat('screen on', 'Screen On');
  }
});
...
eventHTMLElem('click', 'Orange', false, function(event) {
  assignMat('Body 1', 'Body 1 Orange');
  setMaterialColor('Body 2', 'Principled BSDF Color', 1, 0.365529, 0.187791, '');
});
...
eventHTMLElem('click', 'Blue', false, function(event) {
  assignMat('Body 1', 'Body 1 Blue');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.14996, 0.584079, 0.715694, '');
});
