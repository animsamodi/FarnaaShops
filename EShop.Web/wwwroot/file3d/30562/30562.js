...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__Xiaomi_Redmi_Note_9.gltf'.replace('__URL__', '');
    var logicURL = '../file3d/30562/visual_logic.js';
    var sceneURL = '../file3d/30562/Xiaomi_Redmi_Note_9.gltf';
    if (!sceneURL) {
