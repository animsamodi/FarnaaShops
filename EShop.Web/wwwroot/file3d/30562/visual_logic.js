 ...
 * Mon Feb 20 2023 04:26:51 GMT+0330 (Iran Standard Time)
...
assignMat('body.001', 'Body 1 Green');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.012983, 0.141263, 0.14996, '');
OffOn = 0;
...
eventHTMLElem('click', 'DarkBlue', false, function(event) {
  assignMat('body.001', 'Body 1 DarkBlue');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.109461, 0.181164, 0.296138, '');
});
...
eventHTMLElem('click', 'PolarWhite', false, function(event) {
  assignMat('body.001', 'Body 1 PolarWhite');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.332451, 0.473531, 0.597202, '');
});
