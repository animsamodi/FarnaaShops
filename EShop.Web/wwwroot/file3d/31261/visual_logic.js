...
eventHTMLElem('click', 'OffOn', false, function(event) {
  if (OffOn == 0) {
    OffOn = 1;
    assignMat('screen.001', 'Screen Off');
  } else {
    OffOn = 0;
    assignMat('screen.001', 'Screen On');
  }
});
...
eventHTMLElem('click', 'Green', false, function(event) {
  assignMat('Body 1', 'Body 1 Green');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.05448, 0.111932, 0.116971, '');
});
...
eventHTMLElem('click', 'Blue', false, function(event) {
  ...
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.155926, 0.376262, 0.491021, '');
});
