...
(function() {
    ...
    //var sceneURL = params.load ? params.load : '__URL__Xiaomi_12T.gltf'.replace('__URL__', '');
    var logicURL = '../file3d/31358/visual_logic.js';
    var sceneURL = '../file3d/31358/Xiaomi_12T.gltf';
    if (!sceneURL) {
