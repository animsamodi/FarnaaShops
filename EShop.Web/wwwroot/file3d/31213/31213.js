...
(function() {
    ...
    //var sceneURL = params.load ? params.load : '__URL__Samsung_A_04_S.gltf'.replace('__URL__', '');
    var logicURL = '../file3d/31213/visual_logic.js';
    var sceneURL = '../file3d/31213/Samsung_A_04_S.gltf';
    if (!sceneURL) {
