...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.024158, 0.024158, 0.024158, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.024158, 0.024158, 0.024158, '');
OffOn = 0;
...
eventHTMLElem('click', 'AwesomeBlack', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.024158, 0.024158, 0.024158, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.024158, 0.024158, 0.024158, '');
});
...
eventHTMLElem('click', 'AwesomeWhite', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.830769, 0.830769, 0.830769, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.830769, 0.830769, 0.830769, '');
});
...
eventHTMLElem('click', 'AwesomeBlue', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.23455, 0.473531, 0.686685, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.23455, 0.473531, 0.686685, '');
});

eventHTMLElem('click', 'AwesomeViolet', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.545724, 0.520995, 0.672443, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.545724, 0.520995, 0.672443, '');
});
