...
setMaterialColor('Body 2', 'Principled BSDF Color', 0.061246, 0.061246, 0.064803, '');
OffOn = 0;
...
eventHTMLElem('click', 'Yellow', false, function(event) {
  assignMat('body.001', 'Body 1 Yellow');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.723055, 0.527115, 0.000607, '');
});
...
eventHTMLElem('click', 'Blue', false, function(event) {
  ...
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.004777, 0.155926, 0.445201, '');
});
