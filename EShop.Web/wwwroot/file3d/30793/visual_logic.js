 ...
 * Sun Jan 29 2023 00:18:35 GMT+0330 (Iran Standard Time)
...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.021219, 0.021219, 0.021219, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.021219, 0.021219, 0.021219, '');
OffOn = 0;
...
eventHTMLElem('click', 'GraphiteGray', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.021219, 0.021219, 0.021219, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.021219, 0.021219, 0.021219, '');
  changeVis('Point', false);
});
...
eventHTMLElem('click', 'PearlWhite', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.035601, 0.155926, 0.450786, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.035601, 0.155926, 0.450786, '');
  changeVis('Point', false);
});
...
eventHTMLElem('click', 'TwilightBlue', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.533276, 0.533276, 0.723055, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.533276, 0.533276, 0.723055, '');
