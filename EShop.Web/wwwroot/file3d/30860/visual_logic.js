...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.040915, 0.040915, 0.040915, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.040915, 0.040915, 0.040915, '');
OffOn = 0;
...
eventHTMLElem('click', 'Mint', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.467783, 0.603827, 0.552011, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.467783, 0.603827, 0.552011, '');
});
...
eventHTMLElem('click', 'White', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.783537, 0.783537, 0.783537, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.783537, 0.783537, 0.783537, '');
});
