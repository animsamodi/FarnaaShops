...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.006512, 0.006512, 0.006512, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.006512, 0.006512, 0.006512, '');
OffOn = 0;
...
eventHTMLElem('click', 'Gray', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.006512, 0.006512, 0.006512, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.006512, 0.006512, 0.006512, '');
});
...
eventHTMLElem('click', 'White', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.760524, 0.768151, 0.783538, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.760524, 0.768151, 0.783538, '');
});
...
eventHTMLElem('click', 'Mint', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.605121, 0.736805, 0.64734, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.605121, 0.736805, 0.64734, '');
});

eventHTMLElem('click', 'Violet', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.434924, 0.434924, 0.603858, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.434924, 0.434924, 0.603858, '');
});
