...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.035601, 0.033105, 0.036889, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.035601, 0.033105, 0.036889, '');
OffOn = 0;
...
eventHTMLElem('click', 'White', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.938685, 0.938685, 0.938685, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.938685, 0.938685, 0.938685, '');
});
...
eventHTMLElem('click', 'Peach', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.964686, 0.514917, 0.346704, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.964686, 0.514917, 0.346704, '');
});

eventHTMLElem('click', 'Blue', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.617206, 0.768151, 0.938686, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.617206, 0.768151, 0.938686, '');
});
