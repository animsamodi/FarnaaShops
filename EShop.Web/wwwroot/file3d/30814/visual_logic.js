 ...
 * Mon Feb 20 2023 03:13:10 GMT+0330 (Iran Standard Time)
...
setMaterialColor('Body 1', 'Principled BSDF Color', 0.93011, 0.896269, 0.887923, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.93011, 0.896269, 0.887923, '');
OffOn = 0;
...
eventHTMLElem('click', 'DarkBlue', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.038204, 0.048172, 0.082283, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.038204, 0.048172, 0.082283, '');
});
...
eventHTMLElem('click', 'Red', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.701102, 0.046665, 0.052861, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.701102, 0.046665, 0.052861, '');
});

eventHTMLElem('click', 'Gold', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.98225, 0.55834, 0.296138, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.98225, 0.55834, 0.296138, '');
});

eventHTMLElem('click', 'Pink', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.938685, 0.73046, 0.947306, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.938685, 0.73046, 0.947306, '');
});

eventHTMLElem('click', 'Green', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.40724, 0.672443, 0.53948, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.40724, 0.672443, 0.53948, '');
});
