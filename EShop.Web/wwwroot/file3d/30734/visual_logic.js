 ...
 * Wed Jan 18 2023 17:50:22 GMT+0330 (Iran Standard Time)
...
OffOn = 0;
setMaterialColor('Body 1', 'Principled BSDF Color', 0.630757, 0.617206, 0.603827, '');
setMaterialColor('Body 2', 'Principled BSDF Color', 0.630757, 0.617206, 0.603827, '');
...
eventHTMLElem('click', 'Starlight', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.630757, 0.617206, 0.603827, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.630757, 0.617206, 0.603827, '');
});
...
eventHTMLElem('click', 'Midnight', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.009134, 0.012286, 0.015996, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.009134, 0.012286, 0.015996, '');
});
...
eventHTMLElem('click', 'Blue', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.026241, 0.114435, 0.208637, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.026241, 0.114435, 0.208637, '');
});

eventHTMLElem('click', 'Pink', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.775822, 0.590618, 0.564712, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.775822, 0.590618, 0.564712, '');
});

eventHTMLElem('click', 'Red', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.371238, 0.003035, 0.012286, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.371238, 0.003035, 0.012286, '');
});

eventHTMLElem('click', 'Green', false, function(event) {
  setMaterialColor('Body 1', 'Principled BSDF Color', 0.036889, 0.066626, 0.036889, '');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.036889, 0.066626, 0.036889, '');
});
