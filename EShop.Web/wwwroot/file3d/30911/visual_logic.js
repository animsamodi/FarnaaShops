 ...
 * Mon Feb 20 2023 02:57:44 GMT+0330 (Iran Standard Time)
...
assignMat('Back', 'Body 1 Black');
setMaterialColor('Body 2', 'Principled BSDF Color', 0, 0, 0, '');
assignMat('Plane.002', 'BlueLight');
OffOn = 0;
...
eventHTMLElem('click', 'White', false, function(event) {
  assignMat('Back', 'Body 1 White');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.318547, 0.318547, 0.318547, '');
  assignMat('Plane.002', 'BlueLight');
});
...
eventHTMLElem('click', 'Yellow', false, function(event) {
  assignMat('Back', 'Body 1 Yellow');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0, 0, 0, '');
  assignMat('Plane.002', 'YellowLight');
});
