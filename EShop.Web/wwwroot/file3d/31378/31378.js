...
(function() {
    ...
    //var sceneURL = params.load ? params.load : '__URL__Honor_X6.gltf'.replace('__URL__', '');
    var logicURL = '../file3d/31378/visual_logic.js';
    var sceneURL = '../file3d/31378/Honor_X6.gltf';
    if (!sceneURL) {
