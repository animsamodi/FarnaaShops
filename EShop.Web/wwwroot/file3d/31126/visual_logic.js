 ...
 * Mon Jan 30 2023 01:03:36 GMT+0330 (Iran Standard Time)
...
assignMat('Body 1', 'Body 1 GraphiteGray');
...
eventHTMLElem('click', 'PolarWhite', false, function(event) {
  assignMat('Body 1', 'Body 1 PolarWhite');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.533276, 0.533276, 0.533276, '');
});
...
eventHTMLElem('click', 'AtlanticBlue', false, function(event) {
  assignMat('Body 1', 'Body 1 AtlanticBlue');
  setMaterialColor('Body 2', 'Principled BSDF Color', 0.035601, 0.124772, 0.332451, '');
});
