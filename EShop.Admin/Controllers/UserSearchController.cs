...
{
    //[Area("Admin")]
    public class UserSearchController : BaseAdminController
    {
        ...
        {
            var res = _UserSearchService.GetListForAdmin();
            return View(res);
        }
        ...
        public IActionResult Create(UserSearch model)
        {
            bool res = _UserSearchService.Add(model);
        ...
        {
            var data = _UserSearchService.FindById(id);
            if (data == null)
            {
                TempData["res"] = "faild";
                return RedirectToAction(nameof(Index));
            }
            bool res = _UserSearchService.Delete(data);
        ...
        public IActionResult Edit(UserSearch model)
        {
          
            bool res = _UserSearchService.Update(model);
            TempData["res"] = res ? "success" : "faild";
            return RedirectToAction(nameof(Index));
        }
