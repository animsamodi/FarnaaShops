...
using Audit.Core;
using AutoMapper;
using EShop.Admin.Attribute;
using EShop.Admin.Helper;
using EShop.Core.ExternalApi.ImageServer;
...
namespace EShop.Admin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                option.ConnectionString = Configuration.GetConnectionString("CacheConnection");
                option.SchemaName = "dbo";
                option.TableName = "EShopCache";
            });
            ...
            services.AddSingleton(Configuration.GetSection("ApiMedia").Get<MediaConfiguration>());
