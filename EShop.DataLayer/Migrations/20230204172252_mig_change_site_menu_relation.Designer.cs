...
namespace EShop.DataLayer.Migrations
{
    ...
    [Migration("20230204172252_mig_change_site_menu_relation")]
    partial class mig_change_site_menu_relation
    {
            ...
            modelBuilder.Entity("EShop.DataLayer.Entities.SiteMenu", b =>
                {
                    ...
                    b.HasOne("EShop.DataLayer.Entities.SiteMenu", "SiteMenuParent")
                        .WithMany("SiteMenus")
                        .HasForeignKey("Code")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
